...
return [
    ...
    'story' => [
        ...
        'place' => [
            'Le décor de toute l’histoire : {place} - un endroit qui, jusqu’à ce matin, n’avait '
                . 'jamais donné à personne une raison de s’inquiéter.',
            'Tout cela se passe à {place}, qui s’en sortait parfaitement bien jusqu’à aujourd’hui.',
            'Le décor : {place} - un endroit où personne n’avait jamais eu besoin d’être secouru.',
        ],

        'p2' => [
            'La nouvelle circule vite et arrive à {hero} avant tout le monde. Quelque part '
            ...
            'La nouvelle se répand, comme se répandent les nouvelles, et {hero} l’apprend le '
                . 'premier. Là-bas, quelque part, il y a {rescue}, qui attend sans être sûr du tout '
                . 'que quelqu’un arrive. Les grandes personnes en discutent et décident que c’est '
                . 'beaucoup trop loin. Alors {hero} remplit un sac, ne prévient personne et s’en va '
                . 'pendant qu’il reste de la lumière pour marcher.',
            'Au milieu de la matinée tout le monde est au courant, et {hero} l’a entendu deux '
                . 'fois. Au-delà des dernières maisons il y a {rescue}, qui compte sur quelqu’un qui '
                . 'n’est pas encore parti. Aucun adulte ne se propose, alors {hero} prépare un sac, '
                . 's’en va sans un mot et prend la route pendant que le jour tient encore.',
        ],

        'setout' => [
            'Personne ne part pour un voyage pareil les poches vides, alors {hero} emporte du pain, '
            ...
            'On ne prend pas une route pareille les mains vides, alors {hero} emporte du pain, une '
                . 'couverture, une bougie et un bout de ficelle dont personne n’aurait pu deviner '
                . 'l’utilité sur le moment.',
            'Dans le sac il y a ce que {hero} a trouvé en vitesse : du pain, une couverture, une '
                . 'demi-carte et un petit caillou gardé pour la chance depuis un été que plus '
                . 'personne ne se rappelle.',
        ],

        'p3' => [
            'La route se partage en {cells} étapes, et aucune ne laisse passer gratuitement. '
                . '{trouble} À chaque étape une question attend, et bien y répondre est le seul moyen '
                . 'd’avancer.',
            'Il y a {cells} étapes entre ici et là-bas, et chacune demande quelque chose. {trouble} '
                . 'Une question attend à chacune, et une bonne réponse est le seul péage que la '
                . 'route accepte.',
            'Le chemin se coupe en {cells} étapes, et aucune n’est généreuse. {trouble} Chacune a '
                . 'une question en travers, et la seule clé qui entre est une bonne réponse.',
        ],

        'wrong' => [
            'Il y aura des moments où la réponse ne viendra pas. C’est permis. La route te '
            ...
            'Certaines questions ne s’ouvrent pas du premier coup. Ce n’est pas grave, et c’est '
                . 'même prévu. La route te rend un pas, te laisse y repenser une fois de plus, puis '
                . 'continue comme avant. Personne n’a jamais été renvoyé chez lui pour une mauvaise '
                . 'réponse : la route ne s’arrête que pour celui qui arrête de la faire.',
            'Il y aura une question qui reste là, immobile, et tu auras beau la fixer, elle ne '
                . 'bougera pas. Cela arrive à tout le monde. Tu perds un pas, tu réfléchis encore, '
                . 'et tu repars. Se tromper n’a jamais mis fin à un voyage : seulement poser le sac '
                . 'pour de bon.',
        ],

        'last' => [
            'Et puis, d’un coup, il ne reste plus rien entre {hero} et {rescue} qu’une '
                . 'dernière question.',
            'Et il ne reste plus qu’une seule question debout entre {hero} et {rescue}.',
            'Une question de plus, et rien d’autre, sépare {hero} de {rescue}.',
        ],

        'p4' => [
            'Arrive au bout et {rescue} rentre à la maison, et l’histoire de ce jour-là appartient '
                . 'à {hero} pour toujours. Cette histoire s’appelle « {title} ».',
            'Va jusqu’au bout et {rescue} rentre chez lui, et à partir de ce jour l’histoire de ce '
                . 'qui est arrivé appartient à {hero}. Elle porte le nom de « {title} ».',
            'Termine la route et {rescue} dort à la maison ce soir. La raconter revient à {hero} '
                . 'pour toujours, sous le nom de « {title} ».',
        ],

        'opening' => [
            'forest' => [
                'La vieille forêt s’est tue. Même les feuilles dorées ont cessé de tomber, arrêtées en plein vol.',
                'Tous les sentiers du vieux bois se sont tus en même temps, et aucun oiseau ne veut dire pourquoi.',
            ],
            'dino' => [
                'Un énorme rugissement monte de la vallée. Quelque part en bas, un bébé dinosaure s’est perdu.',
                'La vallée entière rugit depuis l’aube, et l’une de ces voix est bien trop petite.',
            ],
            'space' => [
                'La station spatiale lance un appel de détresse : une petite planète va perdre sa lumière pour toujours.',
                'Un signal arrive du bord de la carte, faible et répété : une petite planète s’éteint.',
            ],
            'ocean' => [
                'Le récif de corail devient tout gris et les petits poissons appellent à l’aide.',
                'Quelque chose a quitté le récif pendant la nuit : la couleur d’abord, et puis le bruit.',
            ],
            'pirate' => [
                'Une carte usée arrive sur la plage dans une bouteille et promet un trésor que le monde a oublié.',
                'La marée apporte une bouteille avec une demi-carte dedans et une promesse qui a duré plus longtemps que le bateau d’où elle vient.',
            ],
            'magic' => [
                'La flamme magique de la vieille tour s’est éteinte et tout le royaume s’enfonce dans la brume.',
                'La vieille tour a refroidi pour la première fois depuis trois cents ans, et la brume descend la vallée pour voir ça.',
            ],
            'castle' => [
                'La cloche dorée du château a été volée la veille de la grande fête.',
                'La grande cloche n’a pas sonné ce matin, et à midi tout le royaume savait qu’elle avait disparu.',
            ],
            'desert' => [
                'Le seul oasis du désert sèche un peu plus chaque jour.',
                'Le puits est sorti boueux ce matin, puis presque à sec, et l’oasis rétrécit depuis.',
            ],
            'arctic' => [
                'La plaque de glace où vivent les manchots fond beaucoup trop vite.',
                'La glace a commencé à se parler toute seule dans la baie, et le glaçon où vivent les manchots est plus petit qu’hier.',
            ],
            'candy' => [
                'La rivière de chocolat du Pays des Bonbons a gelé pendant la nuit.',
                'La rivière de chocolat s’est arrêtée dans la nuit, et ce matin on la traverse à pied.',
            ],
            'robot' => [
                'L’usine de robots n’a plus de courant et toutes les machines se sont arrêtées en plein geste.',
                'Toutes les machines de l’usine se sont arrêtées à la même seconde, au milieu de ce qu’elles faisaient.',
            ],
            'farm' => [
                'Tous les animaux de la ferme ont disparu pendant une nuit de grand vent.',
                'Au lever du jour la barrière était ouverte, la cour vide, et aucun animal n’a répondu quand on l’a appelé.',
            ],
        ],
        ...
        'companion' => [
            'forest' => [
                'Une vieille chouette annonce qu’elle ira jusqu’au deuxième virage et pas plus loin. Elle fait finalement tout le chemin, en se plaignant du temps à chaque étape.',
                'Un hérisson avec une toute petite lanterne tient absolument à venir. Il marche si lentement que tout le groupe apprend le nom de choses devant lesquelles il serait passé sans les voir.',
            ],
            'dino' => [
                'Un petit ptérosaure extrêmement bruyant se nomme lui-même guetteur. Il n’a jamais rien repéré d’utile, mais il ne se tait jamais, ce qui vaut presque aussi bien.',
                'Une jeune tricératops se joint au groupe sans qu’on lui demande. Elle ne sait ni grimper ni nager, et elle pousse un arbre tombé hors du chemin en moins d’une minute.',
            ],
            'space' => [
                'La station envoie un drone de réparation avec un seul œil en état de marche et l’habitude de fredonner. Il connaît la route vers exactement une planète et pense que c’est la bonne.',
                'Un robot de charge avec une roue qui grince vient porter les affaires. Il est allé deux fois au bord de la carte, et le rappelle à peu près toutes les dix minutes.',
            ],
            'ocean' => [
                'Un vieux crabe grognon accepte de venir, à une seule condition : que personne ne parle de sa lenteur. Personne n’en parle. Il suit bien mieux qu’on ne le croyait.',
                'Une toute jeune pieuvre se joint à eux et change de couleur dès que quelqu’un la regarde, ce qui fait que tout le monde sait toujours exactement ce qu’elle pense.',
            ],
            'pirate' => [
                'Le perroquet du navire se porte volontaire en premier, surtout parce qu’il connaît la carte par cœur et ne supporte pas de rater le moment où quelqu’un la lit à voix haute.',
                'Le cuisinier du bateau vient aussi, avec une poêle, une cuillère et un avis bien arrêté sur chaque décision prise à partir de maintenant.',
            ],
            'magic' => [
                'Un bout de bougie qui refuse de s’éteindre flotte derrière eux, éclairant tout ce qu’il ne faut pas au moment où il ne faut pas, et très fier de lui.',
                'Une grenouille qui fut autrefois quelqu’un de plus important propose de les guider. Elle ne se rappelle que la moitié d’un sort, mais c’est une moitié très utile.',
            ],
            'castle' => [
                'La chatte du château vient aussi. Elle est passée dans chaque pièce, sous chaque plancher et derrière chaque rideau, et elle se souvient de tout.',
                'Le garçon de cuisine vient en portant la deuxième meilleure lanterne, et il connaît tous les escaliers de service du royaume.',
            ],
            'desert' => [
                'Une jeune chamelle qui a ses idées bien à elle sur la marche se joint à eux à la porte. Elle s’arrête quand ça lui plaît et repart quand ça lui plaît, et elle ne s’est jamais perdue.',
                'Un fennec aux oreilles énormes les rejoint la deuxième nuit. Il entend l’eau trois collines avant tout le monde, et il en est insupportablement content.',
            ],
            'arctic' => [
                'Un petit phoque tout rond les suit dès la première étape, filant devant sur le ventre pour tester la glace et revenant chaque fois dire si elle tiendra.',
                'Un macareux qui survole cette côte depuis neuf hivers vient comme navigateur, et prend la mission plus au sérieux que personne n’a jamais rien pris.',
            ],
            'candy' => [
                'Une souris en pain d’épice sert de guide. Elle grignote une encoche dans chaque panneau pour retrouver le chemin du retour, et mange plusieurs panneaux en entier.',
                'Un ours en pâte d’amande roule derrière le groupe, mange un peu du chemin au passage, s’excuse chaque fois et recommence.',
            ],
            'robot' => [
                'Un robot balayeur rouillé sort par une porte de côté et se joint à eux sans rien demander. Sa carte a quarante ans, mais il connaît un raccourci, et le raccourci existe vraiment.',
                'Un petit drone à la lentille fêlée vole à côté. Il filme tout, ce dont personne n’a besoin, et éclaire les coins sombres, ce dont tout le monde a besoin.',
            ],
            'farm' => [
                'Le chien de la ferme n’a besoin d’aucune invitation. Il attend au portail depuis le lever du jour, le nez pointé vers la route, absolument certain du chemin à prendre.',
                'La plus vieille oie de la ferme vient aussi. Elle s’est échappée onze fois de cette cour et connaît chaque trou de chaque clôture.',
            ],
        ],
